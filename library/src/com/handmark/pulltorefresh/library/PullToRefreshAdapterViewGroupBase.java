...
public abstract class PullToRefreshAdapterViewGroupBase<T extends StaggeredGridView> extends PullToRefreshBase<T> implements
		OnScrollListener {
	...
	public PullToRefreshAdapterViewGroupBase(Context context) {
		super(context);
		mRefreshableView.setOnScrollListener(this);
	}

	public PullToRefreshAdapterViewGroupBase(Context context, AttributeSet attrs) {
		super(context, attrs);
		mRefreshableView.setOnScrollListener(this);
	}

	public PullToRefreshAdapterViewGroupBase(Context context, Mode mode) {
		super(context, mode);
		mRefreshableView.setOnScrollListener(this);
	}

	public PullToRefreshAdapterViewGroupBase(Context context, Mode mode, AnimationStyle animStyle) {
	...
	public final void onScroll(final StaggeredGridView view, final int firstVisibleItem, final int visibleItemCount,
	...
	public final void onScrollStateChanged(final StaggeredGridView view, final int state) {
		/**
...
*/		}
	...
	private boolean isFirstItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			 ...
			 */
			if (mRefreshableView.getFirstPosition() <= 1) {
	...
	private boolean isLastItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			...
			final int lastVisiblePosition = mRefreshableView.getChildCount() - 1;
			...
			if (lastVisiblePosition >= lastItemPosition - 1) {
				final int childIndex = lastVisiblePosition - mRefreshableView.getFirstPosition();
